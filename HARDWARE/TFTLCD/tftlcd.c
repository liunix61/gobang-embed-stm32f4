...
{  
    ...
    {  
        ...
        {
            if(dx > ref)
                LCD_DrawLine(x + ref + 1, y + dy, x + dx, y + dy);
            ...
            {  
                if(x < dx)  
                    ...
                    Temp = x - dx;  
                LCD_DrawLine(Temp, y + dy, x - ref - 1, y + dy);  
            }  
            ...
            {  
                if(y < dx)  
                    ...
                    Temp = y - dx;  
                LCD_DrawLine(x + dy, Temp, x + dy, y + dx);  
            }  
    ...
    {  
        while(dy <= dx)  
        {  
            LCD_Fast_DrawPoint(x + dx, y + dy, color);  
            LCD_Fast_DrawPoint(x - dx, y + dy, color);  
            LCD_Fast_DrawPoint(x + dx, y - dy, color);  
            LCD_Fast_DrawPoint(x - dx, y - dy, color);  
            if(dx != dy)  
            {  
                LCD_Fast_DrawPoint(x + dy, y + dx, color);  
                LCD_Fast_DrawPoint(x + dy, y - dx, color);  
                LCD_Fast_DrawPoint(x - dy, y + dx, color);  
                LCD_Fast_DrawPoint(x - dy, y - dx, color);  
            }  
        ...
        LCD_Fast_DrawPoint(x + r, y, color);  
        LCD_Fast_DrawPoint(x - r, y, color);  
        LCD_Fast_DrawPoint(x, y + r, color);  
        LCD_Fast_DrawPoint(x, y - r, color);  
    }     
}
