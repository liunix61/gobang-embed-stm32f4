...
static char UIStart(void)
{
	...
	//创建按钮
	DrawButton(120, 100, 160, 80, (u8*)"五子棋", 1);
	...
	while (1)
	{
		...
		if (tp_dev.sta&TP_PRES_DOWN)
		{
			...
			if (x > 120 && x < 280 && y > 100 && y < 180)
			{
				...
				{
					ckey = 1;
					DrawButton(120, 100, 160, 80, (u8*)"五子棋", 0);
				}
...
//					return 3;
				case 2:
					DrawButton(120, 150, 160, 80, (u8*)"设置", 1);
					ckey = 0;
					return 2;
				default:
					break;
...
void GameInit(void)
{
	...
	if (g_Mode == 1 )
	{
		...
		POINT_COLOR = RED;
		Show_Str((240 - 24*7), 5, 200, 24, (u8*)"五子棋", 24, 0);
